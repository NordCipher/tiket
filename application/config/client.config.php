...
define('CLIENT_FNAME','COMFY');
define('CLIENT_MNAME','Technologies Private Limited');
define('CLIENT_FULL_NAME', 'COMFY Technologies Private Limited');
define('CLIENT_ADDRESS','PP,MK');
...
define('CLIENT_TICKET_PREFIX', 'TIK-CA-IT-');
...
define('CLIENT_DOMAIN', 'comfy-angel.com.mk');
